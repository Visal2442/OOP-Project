...
let trip2 : Trip = new Trip(new DateTime(5, 10, 2023, new Time(10,0)))
...
let booking2 : Booking = new Booking(new DateTime(20, 2, 2023, new Time(11,0)), "90909", 300, trip1, passenger2, "00000", returnTrip1);
